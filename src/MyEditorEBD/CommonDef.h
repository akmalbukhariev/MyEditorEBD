...
namespace CommonDef
{
	...
	struct STITCH
	{
		 ...
		 static const uchar FUNCTION_FILTER = 0x0F;
		 static const uchar NORMAL_CODE = 0x00;
		 static const uchar NORMAL_CODE_SLOW = 0x0D;
		 static const uchar CC_CODE = 0x01;
		 static const uchar JUMP_CODE = 0x02;
		 static const uchar SEQUIN_CODE = 0x03;
		 static const uchar END_CODE = 0x04;
		 static const uchar SQSTART_CODE = 0x05;
		 static const uchar SQEND_CODE = 0x06;
		 static const uchar FRONTSQ_CODE = 0x07;
		 static const uchar REARSQ_CODE = 0x08;
		 static const uchar ALLSQ_CODE = 0x09;
		 static const uchar STOP_CODE = 0x0A;
		 static const uchar TRIM_STOP_CODE = 0x0B;
		 static const uchar TRIM_CODE = 0x0C;
		 static const uchar ERROR_CODE = 0xFF;

		 static const uchar T_SEQUIN_STEND_CODE = 0x03;
		 
		 static const int FRAME_MARGIN = 5;
		 static const int DRAWING_MARGIN = 15;
		 
		 static const uchar DRAW_GRAYBG = 0x00;
		 static const uchar DRAW_JOB = 0x01;
	};
	...
	struct NeedleSet
	{
		...
		bool operator == (NeedleSet other)
		{
			if (this->Needle != other.Needle ||
	...
	struct EbdHeader
	{
		...
		quint32 JumpNum;			//	Jump Function 개수
		quint16 DesignNameLength;	//	디자인 이름 길이

		quint8* DesignName;			//	디자인 이름
		quint16 FileNameLength;		//	원본 파일 이름 길이

		quint8* FileName;			//	원본 파일 이름
